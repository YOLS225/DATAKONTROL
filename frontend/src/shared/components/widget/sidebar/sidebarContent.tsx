...
const navigation = [
  ...
  { id: 'sources', label: 'Sources', icon: Database, enabled: false },
  { id: 'schemas', label: 'Schemas', icon: Layers3, enabled: false },
  { id: 'uploads', label: 'Uploads', icon: UploadCloud, enabled: false },
  { id: 'reports', label: 'Rapports', icon: FileText, enabled: false },
  { id: 'settings', label: 'Parametres', icon: Settings, enabled: false },
];
